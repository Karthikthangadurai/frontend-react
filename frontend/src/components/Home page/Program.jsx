  ...
  return (
    <section>
        ...
        <div className='bg-slate-100'>
            <h1 className='p-6 bg-slate-100 text-green-900 text-2xl md:text-3xl font-semibold text-center italic shadow'>Our Programmes</h1>
            <div className='m-4 p-2 md:flex md:justify-evenly items-center text-center'>
                   ...
                   <div className='m-4 p-4 bg-white border border-gray-200 shadow rounded '>
                    ...
                    <h2 className='text-lg p-1 font-semibold italic'>Education</h2>
                ...
                <div className='m-4 p-4 bg-white border border-gray-200 shadow rounded'>
                    ...
                    <h2 className='text-lg p-1 font-semibold italic'>Environment</h2>
                ...
                <div className='m-4 p-4 bg-white border border-gray-200 shadow rounded'>
                    ...
                    <h2 className='text-lg p-1 font-semibold italic'>Humanity</h2>
            ...
            <div className="bg-slate-100">
             <h1 className="p-6 bg-slate-100 text-green-900 text-2xl md:text-3xl font-semibold text-center italic border shadow">To Reach Our Goals</h1>
